...
THREE_LINE: List[ThreeLine] = [
    ThreeLine(stcd=62904500, sfsw=11.5, jjsw=13.2, bzsw=15.84, name="无为大堤"),
    ...
    ThreeLine(stcd=62904500, sfsw=11.5, jjsw=13.2, bzsw=14.5, name="惠生连圩堤"),
    ThreeLine(stcd=62904500, sfsw=11.5, jjsw=13.2, bzsw=15.84, name="永定大圩堤"),
    ThreeLine(stcd=62904500, sfsw=11.0, jjsw=13.0, bzsw=13.5, name="黑沙洲、天然洲圩"),
]
